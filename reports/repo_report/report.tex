...
boundaries for run files / JSONL / serving calls, and a clearer
...
first-stage head-to-head, the W6 evaluation layer, the W7
grounding audit, and the W8 triad diagnostic interface.
\Cref{sec:discussion} discusses what the combination of W6 closure,
W7 grounding, and W8 triad diagnostics actually means about
...
under \texttt{scripts/*.py}, W8 is an installable
\texttt{mgq-rag-triad} diagnostic, and W9 is an installable
...
summaries beneath \texttt{outputs/W6\_*/}, \texttt{outputs/W7\_*/},
\texttt{outputs/W8\_rag\_triad/}, and
\texttt{outputs/W9\_context\_packing/}.
...
\subsection{W9 --- context packing and prompt compression}
...
Grounding and W8 triad reports should be read alongside this output
...
\begin{table}[H]
  ...
  \begin{tabularx}{\linewidth}{l>{\ttfamily\raggedright\arraybackslash}X}
    ...
    W9 context packing & mgq-context-packing-report \mbox{--baseline-predictions} \ldots{} \mbox{--compressed-predictions} \ldots{} \mbox{--output-dir} outputs/W9\_context\_packing \\
...
ranks, duplicate documents within a query, non-finite scores, and
non-UTF-8 bytes before expensive generation or analysis starts.
