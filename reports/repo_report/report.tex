...
\hypersetup{
  ...
  pdfsubject={Repository report --- updated 2026-07-18;
...
\begin{titlepage}
  ...
  \vspace{0.35cm}
  {\large Repository report --- updated 2026-07-18\par}
  \vspace{1.05cm}
  \rule{\linewidth}{1.2pt}\par
  ...
  {\renewcommand{\arraystretch}{1.30}%
   \begin{tabular}{@{}r@{\hskip 1.4em}l@{}}
     ...
     \textbf{Current update}          & 2026-07-18 \\
...
This 2026-07-18 update keeps the empirical claims anchored to the
