...
\hypersetup{
  ...
  pdfsubject={Repository report --- updated 2026-06-27;
...
\begin{titlepage}
  ...
  \vspace{0.35cm}
  {\large Repository report --- updated 2026-06-27\par}
  \vspace{1.05cm}
  \rule{\linewidth}{1.2pt}\par
  ...
  {\renewcommand{\arraystretch}{1.30}%
   \begin{tabular}{@{}r@{\hskip 1.4em}l@{}}
     ...
     \textbf{Current update}    & 2026-06-27 \\
...
\begin{itemize}
  ...
  \item A maintained repository surface around the experiments:
        ...
        summaries, a lightweight \texttt{mgq-serve} FastAPI wrapper,
        CI, secret scanning, and separate reproducibility/security
        notes.
\end{itemize}
...
\subsection{Repository status as of 2026-06-27}
