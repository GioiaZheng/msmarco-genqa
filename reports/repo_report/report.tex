...
\begin{table}[H]
  ...
  \input{../generated/tables/dense_retrieval_sample.tex}
\end{table}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.78\linewidth]{dense_vs_bm25_density_curve.png}
...
\begin{table}[H]
  ...
  \input{../generated/tables/rerank_vs_dense.tex}
\end{table}
...
\begin{table}[H]
  ...
  \input{../generated/tables/generation_headline.tex}
\end{table}
...
\begin{table}[H]
  ...
  case.}
  \label{tab:w3-ci}
  \input{../generated/tables/generation_bootstrap_ci.tex}
\end{table}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.62\linewidth]{grounding_delta_vs_query_length.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.62\linewidth]{grounding_delta_vs_n_qrels.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.62\linewidth]{grounding_delta_vs_top3_passage_length.png}
...
in W7-A is \texttt{\seqsplit{cross-encoder/nli-deberta-v3-small}} ---
