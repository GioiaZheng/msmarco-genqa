...
\fancyhead[RE,RO]{\small\itshape MS~MARCO Generative QA --- Repository Report}
...
\hypersetup{
  ...
  pdfsubject={Repository report --- updated 2026-06-11;
              experiment window 2026-03-06 to 2026-05-21},
...
\begin{titlepage}
  ...
  \vspace{0.35cm}
  {\large Repository report --- updated 2026-06-11\par}
  \vspace{1.05cm}
  \rule{\linewidth}{1.2pt}\par
  ...
  {\renewcommand{\arraystretch}{1.30}%
   \begin{tabular}{@{}r@{\hskip 1.4em}l@{}}
     \toprule
     \textbf{Experiment period} & 2026-03-06\,--\,2026-05-21 \quad{\small(11 weeks elapsed; 12-week plan)} \\
     \textbf{Current update}    & 2026-06-11 \\
...
This 2026-06-11 update keeps the empirical claims anchored to the
...
scanning, and a clearer advanced-RAG roadmap.
...
\begin{itemize}
  ...
  \item A maintained repository surface around the experiments:
        ...
        local experiment tracking, a lightweight \texttt{mgq-serve}
        FastAPI wrapper, CI, secret scanning, and separate
...
\subsection{Repository status as of 2026-06-11}
...
\begin{itemize}
  \item \textbf{Workflow facade.}  \texttt{rag-eval run --config
        ...
        retrieval, reranking, generation, bootstrap, and grounding
  ...
  \item \textbf{Research backlog.}  Follow-up issues now separate
        hybrid retrieval fusion, learned sparse retrieval, stronger
        rerankers, chunking protocols, query transformation,
        offline/online indexing, RAG triad evaluation, and adaptive
...
\begin{itemize}
  \item \textbf{Retrieval fusion and retrieval measurement.}
        Introduce reciprocal-rank fusion for \bmtwofive{} and dense
        retrieval, add learned sparse retrieval as a SPLADE-style
        baseline, and report \mrr{} / \ndcg{} consistently across
        first-stage, reranked, and fused retrieval outputs.
  ...
  \item \textbf{Evaluation hardening.}  Extend the current paired
        bootstrap protocol with full-sample \texttt{roberta-large}
        \bertscore{}, an alternative-family faithfulness scorer,
        multiple-comparison correction, and TREC-DL qrels loaders.
  ...
  \item \textbf{Generator and prompt ablations.}  Continue the
        ...
        prompt-compression work to test whether the current
        extractive-grounding ceiling can be moved without sacrificing
        faithfulness.
\end{itemize}
...
the on-disk W3 paired predictions directly.  The current repository
