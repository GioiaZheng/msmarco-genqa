...
\hypersetup{
  ...
  pdfsubject={Repository report --- updated 2026-07-20;
...
\begin{titlepage}
  ...
  \vspace{0.35cm}
  {\large Repository report --- updated 2026-07-20\par}
  \vspace{1.05cm}
  \rule{\linewidth}{1.2pt}\par
  ...
  {\renewcommand{\arraystretch}{1.30}%
   \begin{tabular}{@{}r@{\hskip 1.4em}l@{}}
     ...
     \textbf{Current update}          & 2026-07-20 \\
...
This 2026-07-20 update keeps the empirical claims anchored to the
...
\subsection{Repository status as of 2026-07-18}
...
and the SciFact scientific-claim test collection.  Each run uses its
...
\begin{itemize}
  ...
  \item \textbf{NFCorpus first-stage retrieval.}  The cross-domain
        ...
        once candidates are present, but \recallH{} remains 0.2378.
        Compare a domain-appropriate dense or learned-sparse retriever
        against \bmtwofive{} under the same full-corpus qrels and fixed
        depth before tuning the reranker further.
