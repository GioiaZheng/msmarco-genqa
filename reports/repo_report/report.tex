...
\hypersetup{
  ...
  pdfsubject={Repository report --- updated 2026-07-17;
...
\begin{titlepage}
  ...
  \vspace{0.35cm}
  {\large Repository report --- updated 2026-07-17\par}
  \vspace{1.05cm}
  \rule{\linewidth}{1.2pt}\par
  ...
  {\renewcommand{\arraystretch}{1.30}%
   \begin{tabular}{@{}r@{\hskip 1.4em}l@{}}
     ...
     \textbf{Current update}    & 2026-07-17 \\
...
This 2026-07-17 update keeps the empirical claims anchored to the
...
boundaries for run files / JSONL / serving calls, full-corpus BM25 and
cross-encoder runner support for the judged TREC-DL 2019/2020 passage
tracks, and a clearer advanced-RAG roadmap.  The TREC-DL support is an
execution and provenance boundary; graded evaluation and reportable
benchmark results remain follow-up work.
...
\subsection{Repository status as of 2026-07-17}
...
\begin{itemize}
  ...
  \item \textbf{TREC-DL benchmark surface.}  The full-corpus
        \bmtwofive{} and cross-encoder runners now accept the judged
        TREC-DL 2019 and 2020 passage tracks, isolate outputs by year,
        and record dataset, topic-scope, corpus, and upstream-run
        provenance.  This integration does not add a result row to
        the report: graded relevance evaluation and the reportable
        two-year benchmark remain open follow-up work.
...
\paragraph{TREC-DL runner support is not yet TREC-DL evidence.}
The repository can run full-corpus \bmtwofive{} and cross-encoder
reranking for the judged 2019 and 2020 passage tracks, but the current
runner metrics retain the binary relevance view at threshold~2.
Graded \ndcg{}, independent evaluator agreement, and the two-year
benchmark runs are not part of the historical result set in this
report.  They must be completed before making an external-validity
claim from TREC-DL.
...
\begin{itemize}
  \item \textbf{TREC-DL external-validity sequence.}  First add
        graded relevance metrics with an independent evaluator
        cross-check (\href{https://github.com/GioiaZheng/msmarco-genqa/issues/153}{issue~\#153}).
        Then run separate full-corpus \bmtwofive{} versus
        \bmtwofive{}+cross-encoder benchmarks for the 2019 and 2020
        tracks (\href{https://github.com/GioiaZheng/msmarco-genqa/issues/154}{issue~\#154}),
        keeping every number traceable to its run and manifest.
