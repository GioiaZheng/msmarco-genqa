...
\hypersetup{
  ...
  pdfsubject={Repository report --- updated 2026-06-12;
...
\begin{titlepage}
  ...
  \vspace{0.35cm}
  {\large Repository report --- updated 2026-06-12\par}
  \vspace{1.05cm}
  \rule{\linewidth}{1.2pt}\par
  ...
  {\renewcommand{\arraystretch}{1.30}%
   \begin{tabular}{@{}r@{\hskip 1.4em}l@{}}
     \toprule
     \textbf{Experiment period} & 2026-03-06\,--\,2026-05-21 \quad{\small(11 milestones completed; 12-stage plan)} \\
     \textbf{Current update}    & 2026-06-12 \\
...
This report documents an eleven-stage project that
...
\& grounding), an honest comparison between the initial 12-stage
...
This 2026-06-12 update keeps the empirical claims anchored to the
...
\subsection{Repository status as of 2026-06-12}
...
\texttt{outputs/W6\_*/} and \texttt{outputs/W7\_*/}.
...
claim (one command per stage regenerates every number) tractable ---
...
\begin{itemize}
  \item \textbf{W2:} \bmtwofive{} retrieval, full corpus.  Output:
        \texttt{outputs/W2\_bm25/}.
  \item \textbf{W3:} RAG generation baseline (T5-small over top-3).
        Output:
        \code{outputs/W3\_\allowbreak generation\_\allowbreak \{bm25,reranked\}\_\allowbreak full/}.
  \item \textbf{W4:} dense retrieval, 50k qrels-anchored sample.
        Output: \texttt{outputs/W4\_dense/}.
  \item \textbf{W5:} cross-encoder rerank over dense top-100.
        Output: \texttt{outputs/W5\_reranker\_full/}.
  \item \textbf{W5-A:} same reranker over \bmtwofive{} top-100.
        Output:
        \code{outputs/W5\_\allowbreak rerank\_\allowbreak first\_\allowbreak stage\_\allowbreak compare/}.
  \item \textbf{W6:} \bertscore{} proxy + regression failure
        taxonomy + decode-budget closure.  Outputs:
        \code{outputs/W6\_\allowbreak bertscore\_\allowbreak proxy/},
        \code{outputs/W6\_\allowbreak analysis/},
        \code{outputs/W6\_\allowbreak taxonomy\_\allowbreak mnt128/}.
  \item \textbf{W6-A/B/C:} question-form tagging,
        per-form $\Delta$, regression structural profile.
        Outputs: \code{outputs/W6\_\allowbreak querytype/},
        \code{outputs/W6\_\allowbreak rerank\_\allowbreak by\_\allowbreak form/},
        \code{outputs/W6\_\allowbreak regression\_\allowbreak features/}.
  \item \textbf{W7:} lexical + 3-gram grounding audit; W7-A adds
        ...
        \code{outputs/W7\_\allowbreak grounding/},
        \code{outputs/W7\_\allowbreak grounding\_\allowbreak correlation/},
        \code{outputs/W7\_\allowbreak low\_\allowbreak grounding\_\allowbreak cases/}.
\end{itemize}
\endgroup
