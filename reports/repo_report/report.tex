...
\hypersetup{
  ...
  pdfsubject={Repository report --- updated 2026-07-29;
              ...
              NFCorpus first-stage analysis and bounded query-representation
...
\begin{titlepage}
  ...
  \vspace{0.35cm}
   {\large Repository report --- updated 2026-07-29\par}
  \vspace{1.05cm}
  \rule{\linewidth}{1.2pt}\par
...
result and does not establish cross-domain generation.
