    ...
    return [
        {
            "label": "sample 15k",
            "sample_size": 15000,
            "output_dir": "outputs/dense_density_sweep/sample_15k",
            "reuse_existing": None,
        },
        {
            "label": "sample 30k",
            "sample_size": 30000,
            "output_dir": "outputs/dense_density_sweep/sample_30k",
            "reuse_existing": None,
        },
        {
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument(
        "--output-dir",
        type=Path,
        default=PROJECT_ROOT / "outputs/dense_density_sweep",
    )
    p.add_argument(
        "--figures-dir",
        type=Path,
...
def resolve_encoder_and_baseline(args: argparse.Namespace) -> tuple[str, str]:
    ...
    encoder_summary = PROJECT_ROOT / "outputs/dense_encoder_horizontal/summary.json"
